export const API_ENDPOINTS = {
  ...
  MANAGEMENT: {
    HISTORY: {
      LIST: 'api/v1/p/user/payments', // 결제 내역 목록 조회
  ...
  CARD: {
    ...
    SET_REPRESENTATIVE: (cardId: number) => `api/v1/p/user/cards/${cardId}`, // 주 카드 설정
    DELETE: (cardId: number) => `api/v1/p/user/cards/${cardId}`, // 카드 삭제
  },
} as const;
